package net.ponyglory.tarpo.item.custom;
...
public class SpawnEggs {
     ...
     static public class DarkEggs extends SpawnEggItem {
        protected static final List<DarkEggs> UNADDED_EGGS = new ArrayList<DarkEggs>();
        private final Lazy<? extends EntityType<?>> entityTypeSupplier;

        public DarkEggs(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
